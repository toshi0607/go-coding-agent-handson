// go-coding-agent-handson のミニコーディングエージェント(step 07 時点)。
//
...
//	go run ./steps/07-subagent   # 対話モード(REPL)
//	go run ./steps/07-subagent -p "質問"   # ワンショットモード
package main
...
import (
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/07-subagent/agent"
	"github.com/toshi0607/go-coding-agent-handson/steps/07-subagent/config"
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/07-subagent/prompt"
