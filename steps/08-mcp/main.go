// go-coding-agent-handson のミニコーディングエージェント(step 08 時点)。
//
...
//	go run ./steps/08-mcp   # 対話モード(REPL)
//	go run ./steps/08-mcp -p "質問"   # ワンショットモード
package main
...
import (
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/agent"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/config"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/llm"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/mcp"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/permission"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/prompt"
	"github.com/toshi0607/go-coding-agent-handson/steps/08-mcp/tools"
)
