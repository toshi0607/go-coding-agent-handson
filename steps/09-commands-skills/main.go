// go-coding-agent-handson のミニコーディングエージェント(step 09 時点)。
//
...
//	go run ./steps/09-commands-skills   # 対話モード(REPL)
//	go run ./steps/09-commands-skills -p "質問"   # ワンショットモード
package main
...
import (
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/agent"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/command"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/config"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/llm"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/mcp"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/permission"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/prompt"
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/skill"
