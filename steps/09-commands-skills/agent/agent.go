...
import (
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/09-commands-skills/contextmgr"
...
// ClearHistory は会話履歴を消す(/clear コマンド用)。
func (a *Agent) ClearHistory() {
	a.history = nil
	a.lastUsageTokens = 0
}

// CompactHistory は履歴を要約に置き換える(/compact コマンドと自動発動用)。
