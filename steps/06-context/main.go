// go-coding-agent-handson のミニコーディングエージェント(step 06 時点)。
//
...
//	go run ./steps/06-context   # 対話モード(REPL)
//	go run ./steps/06-context -p "質問"   # ワンショットモード
package main
...
import (
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/06-context/agent"
	"github.com/toshi0607/go-coding-agent-handson/steps/06-context/config"
	...
	"github.com/toshi0607/go-coding-agent-handson/steps/06-context/prompt"
